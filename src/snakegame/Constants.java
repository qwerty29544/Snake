...
public class Constants {
    ...
    public static final int LEFT = 4;//номер клавиши стрелка влево
    public static final int shift = 0;//границы области для конкретной координаты (смещение координаты)
    public static final int step_size = 20;//шаг змейки
}
